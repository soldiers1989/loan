...
@TargetApi(23)
public class BankPay3Activity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_bank_pay3);
...
//		attention.setText(Html.fromHtml("<font color=\"#DA3636\"> Lưu ý:  </font> Phiền quý khách ghi Nội dung chuyển tiền như sau: số CMND xxx trả vay."));
	...
	public void onClick(View v) {
		...
		case R.id.btn_upload:
			if (uploading) {
				ToastUtil.showShort(BankPay3Activity.this, BankPay3Activity.this.getResources().getString(R.string.uploading));
			...
			if (OK) {
				...
				ToastUtil.showShort(BankPay3Activity.this, "no photo!");
	...
	public void onRequestPermissionsResult(int requestCode,
		...
		if (grantResults.length > 0
			...
			Intent intent1 = new Intent(BankPay3Activity.this,
					IndexActivity.class);
	...
	private void takePhoto() {
		Intent intent = new Intent(BankPay3Activity.this,
	...
	private void Upload(final String name, final String path,
		...
		if (drawable2 == null) {
			ToastUtil.showShort(BankPay3Activity.this, "not a photo! please retake!");
				...
				new OSSCompletedCallback<PutObjectRequest, PutObjectResult>() {
					...
					public void onFailure(PutObjectRequest request,
						...
						if (clientExcepion != null) {
							...
							ToastUtil.showShort(BankPay3Activity.this, BankPay3Activity.this.getResources().getString(R.string.host_exception));
						...
						if (serviceException != null) {
							...
							ToastUtil.showShort(BankPay3Activity.this, BankPay3Activity.this.getResources().getString(R.string.host_exception) + serviceException.getRawMessage());
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			...
			// 480);
			if (bitmap == null) {
				ToastUtil.showShort(BankPay3Activity.this, BankPay3Activity.this.getResources().getString(R.string.retake));
		...
		protected void onPostExecute(Bitmap result) {
			...
			if (result != null) {
				...
				if (imageView != null) {
					...
					ToastUtil.showShort(BankPay3Activity.this, BankPay3Activity.this.getResources().getString(R.string.memory_need_more));
	...
	private void showDialog(String Message) {
		new AlertDialog(BankPay3Activity.this)
				.builder()
				.setMsg(Message)
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case Config.UPLOAD_FAILED:
                    ToastUtil.showShort(activityWeakReference.get(), activityWeakReference.get().getResources().getString(R.string.upload_failture));
                    OK = false;
                    rlCredentials.setBackgroundResource(R.drawable.proof);
                    break;
                ...
                case Config.CODE_CONFIRMMONEYBACK:
                    try {
                        ...
                        if (err == 0) {
                            ...
                            ToastUtil.showShort(activityWeakReference.get(), activityWeakReference.get().getResources().getString(R.string.repayment_submitted));

                            Intent intent1 = new Intent(activityWeakReference.get(),
                                    IndexActivity.class);
