...
@TargetApi(23)
public class BaseInfo2Activity extends BaseActivity implements OnClickListener {
...
//	private LinearLayout llName;
	...
	private TextView etAddressNow;
	private EditText etEmail;
	private EditText etPhoneType;
	...
	protected void onResume() {
		...
		if (!TextUtils.isEmpty(addressNow)) {
			etAddressNow.setText(addressNow);
		}
	...
	protected void onStop() {
		...
		editor.putString("baseInfoaddressNow", etAddressNow.getText().toString().trim());
...
//		}
		...
		llCMND = findViewById(R.id.ll_cmnd);
		llCMND.setOnClickListener(this);
		...
		llAddressNow = findViewById(R.id.ll_addressnow);
		...
		llPhoneType = findViewById(R.id.ll_phonetype);
		...
		// }
		// });
		etCMND = findViewById(R.id.et_idnumber);
		etAddress = findViewById(R.id.et_address);
		etAddressNow = findViewById(R.id.et_addressnow);
		etEmail = findViewById(R.id.et_email);
		etPhoneType = findViewById(R.id.et_phonetype);
		// EditUtils.setEtFilter(etName);
		// EditUtils.setEtFilter(etAddress);
		// EditUtils.setEtFilter(etAddressNow);
		// EditUtils.setEtFilter(etPhoneType);
	}
	...
	public void onClick(View v) {
		...
		case R.id.btn_baseinfo_next:
			...
			phoneType = etPhoneType.getText().toString().trim()
					.replace(" ", "-");
...
//								R.string.hint_phone_type));
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (resultCode == RESULT_OK) {
			...
			if (requestCode == 304) {
				etAddressNow.setText(location + " " + fang + " " + jun + " "
						+ province);
