...
public class BindCardActivity extends BaseActivity implements OnClickListener,
	...
	private LinearLayout llBankcardNumber;
	private LinearLayout llBankcardNumberCheck;
	private LinearLayout llBankMaster;
...
//			imm.hideSoftInputFromWindow(llBankMaster.getWindowToken(), 0);
			this.phoneDialog = new android.app.AlertDialog.Builder(BindCardActivity.this).create();
			LayoutInflater lay = LayoutInflater.from(BindCardActivity.this);
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case Config.CODE_ERROR:
				ToastUtil.showShort(BindCardActivity.this, "system error");
				break;
			case Config.CODE_TIMEOUT_ERROR:
				ToastUtil.showShort(BindCardActivity.this, getResources().getString(R.string.timeout_of_network));
				
				break;
			case Config.CODE_URL_ERROR:
				ToastUtil.showShort(BindCardActivity.this, getResources().getString(R.string.url_error));

				break;
			case Config.CODE_NET_ERROR:
				ToastUtil.showShort(BindCardActivity.this, getResources().getString(R.string.network_error));
			...
			case Config.CODE_GETBANKCARD:
				...
				try {
					...
					if (0 == object.getInt("error")) {
						ToastUtil.showShort(BindCardActivity.this, getResources().getString(R.string.bind_successed));
...
//							if ("".equals(sp.getString("sfcmnd", ""))) {
								Intent intent = new Intent(BindCardActivity.this, IDCardActivity.class);
...
//									FacebookAcytivity.class));
						...
						ToastUtil.showShort(BindCardActivity.this, object.getString("msg"));
					}
	...
	private void showDialog(String Message) {
		new AlertDialog(BindCardActivity.this)
				.builder()
				.setMsg(Message)
...
//		}
		if (isExit) {
			Intent intent1 = new Intent(BindCardActivity.this,
					IndexActivity.class);
			...
			isExit = true;
			ToastUtil.showShort(BindCardActivity.this, getResources().getString(R.string.warm_reclick_to_exit_veify));
