...
public class CameraActivity extends BaseActivity implements OnClickListener {
	...
	public void onRequestPermissionsResult(int requestCode,
		...
		if (grantResults.length > 0
			...
			ToastUtil.showShort(CameraActivity.this, getResources().getString(R.string.record_auto_permission));
	...
	protected void enter() {
		new AlertDialog(CameraActivity.this)
				.builder()
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			case Config.CODE_ERROR:
				ToastUtil.showShort(CameraActivity.this, "system error");
				break;
			case Config.CODE_URL_ERROR:
				ToastUtil.showShort(CameraActivity.this, getResources().getString(R.string.url_error));

				break;
			case Config.CODE_NET_ERROR:
				ToastUtil.showShort(CameraActivity.this, getResources().getString(R.string.network_error));

				break;
			case 11:
				ToastUtil.showShort(CameraActivity.this, getResources().getString(R.string.upload_failture));
			...
			case Config.CODE_VIDEO:
				...
				try {
					...
					ToastUtil.showShort(CameraActivity.this, getResources().getString(R.string.data_parsing_error));
		...
		case R.id.btn_loan:
			...
			if (Build.VERSION.SDK_INT >= 23) {
				if (CameraActivity.this
					...
					CameraActivity.this.requestPermissions(new String[] {
