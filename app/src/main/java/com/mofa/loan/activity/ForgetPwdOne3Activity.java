...
public class ForgetPwdOne3Activity extends BaseActivity implements
        OnClickListener {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_otp:
                ...
                if (TextUtils.isEmpty(phone)) {
                    ToastUtil.showShort(ForgetPwdOne3Activity.this, getResources().getString(R.string.warm_no_phonenumber));
                ...
                if (!Validator.isPhoneYueNan(phone)) {
                    ToastUtil.showShort(ForgetPwdOne3Activity.this, getResources().getString(R.string.warm_phonenumber_not_match));
                ...
                if (status) {
                    ...
                    if (cd.isConnectingToInternet()) {
                        ...
                        ToastUtil.showShort(ForgetPwdOne3Activity.this, getResources().getString(R.string.network_error));
    ...
    private void reset() {
        ...
        if (TextUtils.isEmpty(pwd) || TextUtils.isEmpty(pwdCheck)) {
            ToastUtil.showShort(ForgetPwdOne3Activity.this, getResources().getString(R.string.warm_pwd_not_null));

            return;
        }
        if (!pwd.equalsIgnoreCase(pwdCheck)) {
            ToastUtil.showShort(ForgetPwdOne3Activity.this, getResources().getString(R.string.warm_pwd_not_same));
        ...
        if (TextUtils.isEmpty(codeStr) && "no".equalsIgnoreCase(isSendFacebook)) {
            ToastUtil.showShort(ForgetPwdOne3Activity.this, getResources().getString(R.string.hint_code));
        ...
        checkDialog.setOnSureListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (realCode.equalsIgnoreCase(inputCode)) {
                    ...
                    etCode.setText("");
                    ToastUtil.showLong(ForgetPwdOne3Activity.this, "Sai mã xác nhận!");
                }
            }
        });
    ...
    private void showdialog2() {
        final android.app.AlertDialog phoneDialog = new android.app.AlertDialog.Builder(
                ForgetPwdOne3Activity.this).create();
        LayoutInflater lay = LayoutInflater.from(ForgetPwdOne3Activity.this);
    ...
    public void onBackPressed() {
        if (isExit) {
            ...
            isExit = true;
            ToastUtil.showShort(ForgetPwdOne3Activity.this, getResources().getString(R.string.warm_reclick_to_exit));
