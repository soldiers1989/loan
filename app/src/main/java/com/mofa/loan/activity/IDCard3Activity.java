...
@SuppressLint("NewApi")
public class IDCard3Activity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		setContentView(R.layout.activity_id_card3);
	...
	public void onRequestPermissionsResult(int requestCode,
		...
		if (grantResults.length > 0
			...
			Intent intent1 = new Intent(IDCard3Activity.this,
					IndexActivity.class);
	...
	private void initdata() {
		...
		if ("base".equalsIgnoreCase(from)) {
			...
			rlCard.setBackgroundResource(R.drawable.cmnd_front);
...
//			findViewById(R.id.ll_veifingstudent).setVisibility(View.VISIBLE);
	...
	private void initview() {
		...
		tvTitle = findViewById(R.id.title_txt_center);
	...
	private void takePhoto() {
		...
		Intent intent = new Intent(IDCard3Activity.this,
		...
		try {
			...
			if (!file.exists()) {
				ToastUtil.showShort(IDCard3Activity.this, "create file failed");
			}
		}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (resultCode == RESULT_OK) {
			...
			if (bitmap == null) {
				ToastUtil.showShort(IDCard3Activity.this, getResources()
	...
	private void Upload(final String name, final String path,
		...
		if (drawable2 == null) {
			ToastUtil.showShort(IDCard3Activity.this,
	...
	public void onClick(View v) {
		...
		case R.id.btn_next:
			...
			if (!isFinished) {
				ToastUtil.showShort(IDCard3Activity.this, "no photo!");
            ...
            switch (msg.what) {
                case Config.UPLOAD_FAILED:
                    ...
                    if (nowStatus == 1001) {
                        ...
                        rlCard.setBackgroundResource(R.drawable.cmnd_back);
                        Log.i("MOFA", "IDCard---身份反面上传失败！");
                    } else if (nowStatus == 1003) {
                        rlCard.setBackgroundResource(R.drawable.cmnd_handhold);
                ...
                case Config.CODE_ERROR:
                    ToastUtil.showShort(IDCard3Activity.this, "system error");
                    break;
                case 2000:
                    ToastUtil.showShort(IDCard3Activity.this, (String) msg.obj);
