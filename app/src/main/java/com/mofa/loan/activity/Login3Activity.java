...
@TargetApi(23)
public class Login3Activity extends BaseActivity implements OnClickListener {
...
//         }
    ...
    private void showDialog(String Message) {
        new AlertDialog(Login3Activity.this)
                .builder()
                .setMsg(Message)
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_contact:
                ...
                final android.app.AlertDialog phoneDialog = new android.app.AlertDialog.Builder(Login3Activity.this)
                        .create();
                LayoutInflater lay2 = LayoutInflater.from(Login3Activity.this);
                        ...
                        new OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                cmb.setPrimaryClip(ClipData.newPlainText(null,
                                        "0906608816"));
                                ToastUtil.showShort(Login3Activity.this, getResources()
                ...
                inflate2.findViewById(R.id.btn_copy_facebook)
                        .setOnClickListener(new OnClickListener() {
                            ...
                            public void onClick(View v) {
                                phoneDialog.dismiss();
                                if (SplashActivity.isAvilible(Login3Activity.this,
                                        "com.facebook.katana")) {
                                    ...
                                    boolean canResolveIntent = intent1.resolveActivity(Login3Activity.this
                                            .getPackageManager()) != null;
                                    if (canResolveIntent){
                                        Login3Activity.this.startActivity(intent1);
                                    } else {
    ...
    private void showdialog() {
        ...
        checkDialog.setOnSureListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (realCode.equalsIgnoreCase(inputCode)) {
                    ...
                    etCode.setText("");
                    ToastUtil.showLong(Login3Activity.this, "Sai mã xác nhận!");
                }
            }
        });
        checkDialog.setOnChangeListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ivCode.setImageBitmap(Code.getInstance().createBitmap());
                checkDialog.setCode(Code.getInstance().getCode());
    ...
    private void showdialog2() {
        final android.app.AlertDialog phoneDialog = new android.app.AlertDialog.Builder(
                Login3Activity.this).create();
        LayoutInflater lay = LayoutInflater.from(Login3Activity.this);
    ...
    public void phoneLogin() {
        final Intent intent = new Intent(Login3Activity.this,
...
//                    ToastUtil.showLong(LoginActivity.this, phoneNumberString);
                                Intent intent = new Intent(Login3Activity.this, Register3Activity.class);
                        ...
                        AccountKit.getCurrentAccount(new AccountKitCallback<Account>() {
                            ...
                            public void onSuccess(final Account account) {
                                ...
                                if (phoneNumber != null) {
                                    ...
                                    Log.i("MOFA", "Facebook认证手机号：" + phoneNumberString);
//                    ToastUtil.showLong(LoginActivity.this, phoneNumberString);
                                    Intent intent = new Intent(Login3Activity.this, ForgetPwdOne3Activity.class);
                                    intent.putExtra("phone", phoneNumberString.replace("+84", "0"));
                                    intent.putExtra("isSendFacebook", "yes");
                                    startActivity(intent);
                                }
    ...
    public boolean isEmulator() {
        ...
        // 是否可以处理跳转到拨号的 Intent
        boolean canResolveIntent = intent.resolveActivity(Login3Activity.this
                .getPackageManager()) != null;
        ...
        return Build.FINGERPRINT.startsWith("generic")
                ...
                || ((TelephonyManager) Login3Activity.this
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case Config.CODE_URL_ERROR:
                    ToastUtil.showShort(activityWeakReference.get(), getResources()
                ...
                case Config.CODE_TIMEOUT_ERROR:
                    ToastUtil.showShort(activityWeakReference.get(), "TIME OUT");
                ...
                case Config.CODE_SENDFACEBOOK:
                    ...
                    try {
                        ...
                        if ("0".equalsIgnoreCase(code)) {
                            Intent intent = new Intent(activityWeakReference.get(), Register3Activity.class);
                ...
                case Config.CODE_SENDFACEBOOK_FORGET:
                    ...
                    try {
                        ...
                        String code = jsonObject.getString("keycode");
                        if ("0".equalsIgnoreCase(code)) {
                            Intent intent = new Intent(activityWeakReference.get(), ForgetPwdOne3Activity.class);
                            intent.putExtra("isSendFacebook", "no");
                            startActivity(intent);
                        } else {
                            phoneLogin2();
