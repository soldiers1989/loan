...
public class News3Activity extends BaseActivity implements OnClickListener,
		IXListViewListener {
	...
	private void initView() {
		...
		adapter = new NewsAdapter2(News3Activity.this, arrayList);
	...
	private void setDialog() {
		new com.mofa.loan.utils.AlertDialog(News3Activity.this)
...
//			startActivity(intent);
			if ("push".equals(from)) {
				Intent i = new Intent(News3Activity.this, IndexActivity.class);
				startActivity(i);
			}
			finish();
			break;
