...
import com.mofa.loan.adapter.Out_MoneyAdapter2;
...
public class OutMoneyRecordActivity extends BaseActivity implements
	...
	private Out_MoneyAdapter2 adapter;
	...
	private void initView() {
		...
		adapter = new Out_MoneyAdapter2(OutMoneyRecordActivity.this, arrayList);
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case Config.CODE_URL_ERROR:
				ToastUtil.showShort(OutMoneyRecordActivity.this, getResources().getString(R.string.url_error));

				break;
			case Config.CODE_NET_ERROR:
				ToastUtil.showShort(OutMoneyRecordActivity.this, getResources().getString(R.string.network_error));

				break;
			case Config.CODE_ERROR:
				ToastUtil.showShort(OutMoneyRecordActivity.this, "system error");
				break;
...
//						setDialog();
						...
						for (int i = 0; i < array.length(); i++) {
							...
							if (jk_date==1) {
								pojo.setDate(getResources().getString(R.string.period_15));
							}else{
								pojo.setDate(getResources().getString(R.string.period_30));
							}
					...
					ToastUtil.showShort(OutMoneyRecordActivity.this, getResources().getString(R.string.data_parsing_error));
	...
	private void setDialog() {
		new com.mofa.loan.utils.AlertDialog(OutMoneyRecordActivity.this)
