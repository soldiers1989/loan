...
//            }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_register_protocol:
                Intent intents = new Intent(Register3Activity.this,
            ...
            case R.id.btn_otp:
                ...
                if (TextUtils.isEmpty(phoneStr)) {
                    ToastUtil.showShort(Register3Activity.this, getResources()
        ...
        checkDialog.setOnSureListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (realCode.equalsIgnoreCase(inputCode)) {
                    ...
                    etCode.setText("");
                    ToastUtil.showLong(Register3Activity.this,
                            "Sai mã xác nhận!");
                }
            }
        });
    ...
    private void showdialog2() {
        final android.app.AlertDialog phoneDialog = new android.app.AlertDialog.Builder(
                Register3Activity.this).create();
        LayoutInflater lay = LayoutInflater.from(Register3Activity.this);
    ...
    private void register() {
        ...
        if (!check) {
            ToastUtil.showShort(Register3Activity.this,
    ...
    public void phoneLogin() {
        final Intent intent = new Intent(Register3Activity.this,
    ...
    public boolean isEmulator() {
        ...
        // 是否可以处理跳转到拨号的 Intent
        boolean canResolveIntent = intent.resolveActivity(Register3Activity.this
        ...
        return Build.FINGERPRINT.startsWith("generic")
                ...
                || ((TelephonyManager) Register3Activity.this
                ...
                case Config.CODE_RGISTER:
                    ...
                    try {
                        ...
                        if (error != 0) {
                            ...
                            Intent intent = new Intent(activityWeakReference.get(), Login3Activity.class);
                            ...
                            AppsFlyerLib.getInstance().trackEvent(activityWeakReference.get(), "Register",
                                    eventValues);
                            ...
                            editor.commit();
                            Intent intent = new Intent(activityWeakReference.get(), IndexActivity.class);
                            startActivity(intent);
                            finish();
                        }
