...
@TargetApi(23)
public class RelationInfo3Activity extends BaseActivity implements
        OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_relation_info3);
        initview();
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (grantResults.length > 0
            ...
            Intent intent = new Intent(RelationInfo3Activity.this,
                    IndexActivity.class);
    ...
    private void initview() {
        ...
        ((TextView) findViewById(R.id.title_txt_center)).setText("Xác minh người liên hệ");
    ...
    private void showdialog2() {
        new ActionSheetDialog(RelationInfo3Activity.this)
                .builder()
                .setCancelable(true)
    ...
    private void showDialog(String Message) {
        new AlertDialog(RelationInfo3Activity.this)
                .builder()
                .setMsg(Message)
    ...
    public void onBackPressed() {
        if (isExit) {
            Intent intent1 = new Intent(RelationInfo3Activity.this,
                    IndexActivity.class);
            ...
            isExit = true;
            ToastUtil.showShort(RelationInfo3Activity.this, getResources()
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case Config.CODE_CONTACT_FAIL:
                    ToastUtil.showShort(activityWeakReference.get(), "upload wrong");
